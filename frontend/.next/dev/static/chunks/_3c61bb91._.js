...
function AnalyticsPage() {
    ...
    const processed = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AnalyticsPage.useMemo[processed]": ()=>{
            return asteroids.map({
                "AnalyticsPage.useMemo[processed]": (asteroid)=>({
                        ...asteroid,
    ...
    const hazardCounts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AnalyticsPage.useMemo[hazardCounts]": ()=>{
            return processed.reduce({
                "AnalyticsPage.useMemo[hazardCounts]": (acc, asteroid)=>{
    ...
    const nearestApproaches = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AnalyticsPage.useMemo[nearestApproaches]": ()=>{
            return [
                ...processed
            ].filter({
                "AnalyticsPage.useMemo[nearestApproaches]": (asteroid)=>asteroid.distance && asteroid.distance > 0
            }["AnalyticsPage.useMemo[nearestApproaches]"]).sort({
                "AnalyticsPage.useMemo[nearestApproaches]": (a, b)=>(a.distance || 0) - (b.distance || 0)
            }["AnalyticsPage.useMemo[nearestApproaches]"]).slice(0, 3);
        }
    }["AnalyticsPage.useMemo[nearestApproaches]"], [
        processed
    ]);
    const trendData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AnalyticsPage.useMemo[trendData]": ()=>{
            const today = new Date();
            return Array.from({
                length: 7
            }).map({
                "AnalyticsPage.useMemo[trendData]": (_, index)=>{
                    const day = new Date(today);
                    day.setDate(today.getDate() + index);
                    const label = formatDayLabel(day);
                    const count = processed.filter({
                        "AnalyticsPage.useMemo[trendData]": (asteroid)=>{
                    ...
                    }["AnalyticsPage.useMemo[trendData]"]).length;
                    return {
                        day: label,
                        count
                    };
    ...
    const velocityBands = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AnalyticsPage.useMemo[velocityBands]": ()=>{
            const bands = {
                slow: 0,
                steady: 0,
                fast: 0
            ...
            processed.forEach({
                "AnalyticsPage.useMemo[velocityBands]": (asteroid)=>{
    ...
    const riskDistribution = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AnalyticsPage.useMemo[riskDistribution]": ()=>{
            return [
                {
                    risk: 'Low',
    ...
    const riskAssessment = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AnalyticsPage.useMemo[riskAssessment]": ()=>{
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                ...
                                children: nearestApproaches.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    ...
                                    lineNumber: 362,
                                    columnNumber: 15
                                }, this) : nearestApproaches.map((asteroid)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(AnalyticsPage, "h6TbEy1Fhoi4U3uB+GgMHl9uSx0=");
_c = AnalyticsPage;
var _c;
...
//# sourceMappingURL=_3c61bb91._.js.map